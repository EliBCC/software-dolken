...
// ----------------------------------------------------------------------------
bool
modm::platform::ClockControl::enableInternalClock(uint32_t waitCycles)
{
	bool retval;
	RCC->CR |= RCC_CR_HSION;
...
bool
modm::platform::ClockControl::enableExternalClock(uint32_t waitCycles)
{
	bool retval;
...
bool
modm::platform::ClockControl::enableExternalCrystal(uint32_t waitCycles)
{
	bool retval;
...
bool
modm::platform::ClockControl::enableLowSpeedInternalClock(uint32_t waitCycles)
{
	bool retval;
...
bool
modm::platform::ClockControl::enableLowSpeedExternalClock(uint32_t waitCycles)
{
	bool retval;
...
bool
modm::platform::ClockControl::enableLowSpeedExternalCrystal(uint32_t waitCycles)
{
	bool retval;
...
// ----------------------------------------------------------------------------
bool
modm::platform::ClockControl::enablePll(PllSource source, uint8_t pllM,
