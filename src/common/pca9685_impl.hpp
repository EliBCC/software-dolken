...
Pca9685<I2cMaster>::initialize(uint8_t mode1, uint8_t mode2)
{
	RF_BEGIN();
...
template<typename I2cMaster>
modm::ResumableResult<bool>
Pca9685<I2cMaster>::setChannel(uint8_t channel, uint16_t value)
{
	RF_BEGIN();
...
template<typename I2cMaster>
modm::ResumableResult<bool>
Pca9685<I2cMaster>::setAllChannels(uint16_t value)
{
	RF_BEGIN();
