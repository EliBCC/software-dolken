...
class W25m : public modm::BlockDevice, public modm::SpiDevice< Spi >, protected modm::NestedResumable<5>
{
public:
...
public:
	...
	{
		Busy					= modm::Bit0,
		WriteEnabled			= modm::Bit1,
		EraseSuspended			= modm::Bit2,
		ProgramSuspended		= modm::Bit3,
		WriteProtectionLockDown	= modm::Bit4,
		SecurityIdLocked		= modm::Bit5,
		//Reserved				= Bit6,
		//Busy					= Bit7, // see Bit0
	};
...
private:
	...
	static constexpr uint8_t dieSelectInstructionBuffer[2] = {static_cast<uint8_t>(Instruction::DieSel), dieId};
